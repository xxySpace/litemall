...
public class WxGoodsController {
     ...
     * @return 二维码的存储地址
     */
    @GetMapping("shareGoodQRCode")
    public Object shareGoodQRCode(@NotNull Integer id, String goodUrl, String name) {
        ...
        String qRCodeAddress = qrCodeService.createGoodShareQRCode(String.valueOf(id), goodUrl, name);
        return ResponseUtil.ok(qRCodeAddress);
    }
}